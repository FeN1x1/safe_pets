<template>
  <div id="blog" class="px-4 xl:px-4 pt-4 pb-16">
    <div class="mx-auto container">
      <span role="contentinfo">
        <AppTitle :title="$t('news.title')" />
      </span>
      <div
        tabindex="0"
        ...
        >
          <div tabindex="0" class="focus:outline-none" aria-label="card 1">
            <img
              ...
              alt="code editor"
            />
            <div class="py-4 px-8 w-full bg-green-primary">
            ...
            >
              ...
              <div class="w-full flex justify-end">
                <button
                  ...
                  "
                >
                  <span class="text-base tracking-wide text-green-primary"
                    >Read more</span
                  >
                  <svg
                    class="ml-3 lg:ml-6 text-green-primary"
